...
do  
    ...
    do 
        ...
        do
            ...
            repoJson="{\"key\":\"$projectKey-$repo$repoId-$level-$repoLocator\",\"projectKey\":\"$projectKey\",\"environments\":$repoEnv,\"rclass\":\"$repoLocator\",\"packageType\":\"$repo\",\"description\":\"$repoPublicDescription\",\"notes\":\"$repoInternalDescription\",\"repoLayoutRef\" :\"$repoLayout\",\"xrayIndex\":\"true\",\"propertySets\":[\"artifactory\"]}"
